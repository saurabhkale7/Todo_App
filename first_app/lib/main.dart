...
class SplashScreenState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Container(
        color: Colors.yellow,
        child: Image.asset("assets/images/app_icon.png",height: 400,width: 400,alignment: Alignment.center,),
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              TextFormField(
                autofocus: true,
                controller: titleCtrl=TextEditingController(text: i==-1?'':l1[i]),
                decoration: InputDecoration(hintText: i==-1?'Enter the title':'', labelText: 'Title'),
              ),
              TextFormField(
                controller: descCtrl=TextEditingController(text: i==-1?'':l2[i]),
                decoration: InputDecoration(hintText: i==-1?'Enter the description':'', labelText: 'Description'),
              ),
            ],
          ),
          actions: [
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index){
          return Padding(
            ...
            child: ListTile(
              title: Text(l1[index], style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold),),
              subtitle: Text(l2[index], style: TextStyle(color: Colors.white, fontSize: 20),),
